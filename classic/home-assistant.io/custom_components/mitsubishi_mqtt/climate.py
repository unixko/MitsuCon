...
from homeassistant.components.climate.const import (
    ...
    HVAC_MODE_HEAT_COOL, HVAC_MODE_OFF, HVAC_MODE_COOL, HVAC_MODE_DRY, HVAC_MODE_HEAT, HVAC_MODE_FAN_ONLY,
...
ha_to_me = {HVAC_MODE_HEAT_COOL: 'AUTO', HVAC_MODE_COOL: 'COOL', HVAC_MODE_DRY: 'DRY', HVAC_MODE_HEAT: 'HEAT', HVAC_MODE_FAN_ONLY: 'FAN', HVAC_MODE_OFF: 'OFF'}
